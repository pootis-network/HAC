--[[
	...
	This was only used on one single server, the UnitedHosts Deathmatch. Go cheat somewhere else.
...
HAC_Credits		   = [[
	...
	GMod 13 fixing = Fangli/HeX/Unknown #3
...
local MSGHook		= "hx_UH_HAC_UHDM_2020"
local Silent		= false
...
Red 		= {r=255,g=0,  b=11, a=255}
Green		= {r=66, g=255,b=96, a=255}
Blue		= {r=51, g=153,b=255,a=255}
Purple	= {r=255,g=0,  b=255,a=255}
Cyan		= {r=0,  g=100,b=255,a=255}
...
NotHH.InitPostEntity.Hooks = function()
	...
	RunConsoleCommand("_hx_hu_cah_ponswna", "UH_2020C", 1531 or 8888, Init+8, Thong("EIGHT", 8), HACKey or 88)
